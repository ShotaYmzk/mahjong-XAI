...
OUTPUT_HDF5_FILENAME = "mahjong_imitation_data_v1112.hdf5" # ★変更点: 出力HDF5ファイル名
...
# --- Logging Setup ---
LOG_FILE = "data_processing_v1112.log"
...
def main():
    ...
    # --- Use only 25% of the XML files at random ---
    num_to_select = max(1, len(xml_files) // 4)
    xml_files = random.sample(xml_files, num_to_select)
