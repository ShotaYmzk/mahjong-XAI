...
# --- モデル保存関連 ---
MODEL_SAVE_PATH = "./trained_model/mahjong_transformer_v1111_large_compiled_2.pth" # 最良モデルの保存パス (compile版を示す名前に変更)
...
PROFILER_LOG_DIR = "./profiler_logs_v1111_large_compiled_2"                    # プロファイラログの出力先 ★追加
